...
describe('geo.annotation', function () {
  ...
  function createEditableAnnotation(map, layer, pts) {
    ...
    ann._addEditHandles(features, ann._coordinates(), true, true, true, true);
  ...
  describe('geo.annotation.annotation', function () {
    ...
    it('_addEditHandles', function () {
      ...
      expect(ann._addEditHandles(features, ann._coordinates())).toBe(undefined);
      // just vertices
      ...
      handles.splice(0, handles.length);
      ann._addEditHandles(features, ann._coordinates(), false, true, true, true);
      ...
      // vertices and center
      handles.splice(0, handles.length);
      ann._addEditHandles(features, ann._coordinates(), false, true);
      expect(handles.length).toBe(4);
      expect(handles[3].type).toBe('center');
      // vertices and rotate
      handles.splice(0, handles.length);
      ann._addEditHandles(features, ann._coordinates(), false, false, true);
      expect(handles.length).toBe(4);
      expect(handles[3].type).toBe('rotate');
      expect(ann._editHandle.amountRotated).toBe(0);
      // vertices and resize
      handles.splice(0, handles.length);
      ann._addEditHandles(features, ann._coordinates(), false, false, false, true);
      expect(handles.length).toBe(4);
